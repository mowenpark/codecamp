...
ActiveRecord::Schema.define(version: 20160303225425) do
  ...
  add_index "follows", ["program_id"], name: "index_follows_on_program_id", using: :btree
  ...
  add_index "languages", ["program_id"], name: "index_languages_on_program_id", using: :btree
