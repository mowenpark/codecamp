  ...
  render: function() {
    ...
    return (
        ...
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            <div className="modal-header">
              ...
              <h4 className="modal-title" id="myModalLabel">Review form</h4>
            </div>
      ...
      <div className="modal-footer">
        ...
        <button type="button" onClick={this.handleSubmit} data-dismiss="modal" className="btn btn-primary">Submit</button>
        </div>
    </div>
  </div>
</div>
